...
const firstRow = $('<div id="one"><div class="cell">$100</div><div class="cell">$100</div><div class="cell">$100</div><div class="cell">$100</div><div class="cell">$100</div></div><br><br>')
body.append(firstRow)
const secondRow = $('<div id="two"><div class="cell">$200</div><div class="cell">$200</div><div class="cell">$200</div><div class="cell">$200</div><div class="cell">$200</div></div><br><br>')
body.append(secondRow)
const thirdRow = $('<div id="three"><div class="cell">$300</div><div class="cell">$300</div><div class="cell">$300</div><div class="cell">$300</div><div class="cell">$300</div></div><br><br>')
body.append(thirdRow)
const fourthRow = $('<div id="four"><div class="cell">$400</div><div class="cell">$400</div><div class="cell">$400</div><div class="cell">$400</div><div class="cell">$400</div></div><br><br>')
body.append(fourthRow)
const fifthRow = $('<div id="five"><div class="cell">$500</div><div class="cell">$500</div><div class="cell">$500</div><div class="cell">$500</div><div class="cell">$500</div></div><br><br>')
body.append(fifthRow)

const score = $('<div id="score">SCORE:</div><br><br>')
body.append(score)

const inputArea = $('#input-area')
const questionArea = $('<div id="question-area"><div id="category"></div><div id="question"></div></div>')
body.append(questionArea)
const label = $('<label for="answer"></label/>')
const answer = $('<input id="answer" placeholder="What/Who is"/>')
const submit = $('<button id="submit">SUBMIT</button><br><br>')
...
function random (){
    ...
    cell1.click(function(e){
        ...
        const backco = JSON.stringify(block1.css('backgroundColor',  'blue'))
        ...
        cell2.click(function(e){
            const block = e.target
            block1 = $(block)
            block1.css('backgroundColor',  'blue')
            if(block1.text() === '$200'){
                ...
                for (const item of arr1){
                    if(item.question === obj.question){
                        if (answerValue.toUpperCase() === obj.answer.toUpperCase()){
                            ...
                            let text = 'Incorrect. The answer we were looking for is... ' + obj.answer + '.'
                            questionDiv.text(text)
                            categoryDiv.text('')
                        }
                    }
    ...
    but.click(function (){
        if (but.css('backgroundColor','white')){
            for(const buttons of catButton){
                const butts = $(buttons)
                butts.css('backgroundColor','blue')
            }
            but.css('backgroundColor', 'darkblue')
        }
